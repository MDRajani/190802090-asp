...
<div id="page-wrapper">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            ...
                                            <div class="col-md-10 col-md-offset-1">
                                                ...
                                                <div class="user-img pull-right">
                                                    <img src="src1/img/user.gif" alt="" class="img-u image-responsive" />
                                                </div>
                                        ...
                                        <div class="item">
                                            <div class="col-md-10 col-md-offset-1">
                                                ...
                                                <h4><i class="fa fa-quote-left"></i>Lorem ipsum dolor sit amet, consectetur adipiscing Lorem ipsum dolor sit amet, consectetur adipiscing elit onec molestie non sem vel condimentum. <i class="fa fa-quote-right"></i></h4>
                                                <div class="user-img pull-right">
                                                    <img src="src1/img/user.png" alt="" class="img-u image-responsive" />
                                                </div>
                                                <h5 class="pull-right"><strong class="c-black">Lorem Dolor</strong></h5>
                                            </div>
                            ...
                            <div id="carousel-example" class="carousel slide" data-ride="carousel" style="border: 5px solid #000;">
                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        ...
                                        <img src="src1/img/slideshow/1.jpg" alt="" />

                                    </div>
                                    <div class="item">
                                        <img src="src1/img/slideshow/2.jpg" alt="" />

                                    </div>
                                    <div class="item">
                                        <img src="src1/img/slideshow/3.jpg" alt="" />
        ...
        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="media">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle img-comments" src="src1/img/user.png" />
                                                </a>
                                                <div class="media-body">
              ...
              <!-- Nested media object -->
                                                    <div class="media">
                                                        <a class="pull-left" href="#">
                                                            <img class="media-object img-circle img-comments" src="src1/img/user.gif" />
                                                        </a>
                                                        <div class="media-body">
